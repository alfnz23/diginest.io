...
export const supportedLanguages: LanguageOption[] = [
  ...
  { code: 'de', name: 'German', nativeName: 'Deutsch', flag: '🇩🇪', currency: 'EUR', currencySymbol: '€' },
  { code: 'pt', name: 'Portuguese', nativeName: 'Português', flag: '🇵🇹', currency: 'EUR', currencySymbol: '€' },
  { code: 'it', name: 'Italian', nativeName: 'Italiano', flag: '🇮🇹', currency: 'EUR', currencySymbol: '€' },
  { code: 'ja', name: 'Japanese', nativeName: '日本語', flag: '🇯🇵', currency: 'JPY', currencySymbol: '¥' },
  { code: 'ko', name: 'Korean', nativeName: '한국어', flag: '🇰🇷', currency: 'KRW', currencySymbol: '₩' },
  { code: 'zh', name: 'Chinese', nativeName: '中文', flag: '🇨🇳', currency: 'CNY', currencySymbol: '¥' }
];
...
export const translations = {
  en: {
    ...
    'home.hero.description': 'Discover beautifully crafted eBooks, planners, schedulers, and digital tools designed to elevate your workflow and inspire your best work.',
    ...
    'home.categories.description': 'Discover our curated collections of premium digital products designed for every aspect of your life.',
    'home.categories.browse': 'Browse',

    'home.featured.title': 'Featured Products',
    'home.featured.description': 'Handpicked digital products that our customers love most.',
    ...
    'products.description': 'Discover our complete collection of premium digital products',
    ...
    'checkout.instantDeliveryDesc': 'Download links will be available immediately after payment',
    'checkout.secureCheckout': 'Secure Checkout',
    'checkout.stripeDescription': 'Complete your purchase with Stripe\'s secure payment system',
    ...
    'admin.description': 'Manage your digital products, payments, and monitor store performance',
    ...
    'footer.newsletter.description': 'Get the latest products and exclusive offers',
    ...
    'auth.welcomeDesc': 'Sign in to your account or create a new one to start shopping',
    'auth.email': 'Email',
  ...
  es: {
    ...
    'home.hero.description': 'Descubre eBooks, planificadores, programadores y herramientas digitales bellamente diseñadas para elevar tu flujo de trabajo e inspirar tu mejor trabajo.',
    'home.hero.exploreBtn': 'Explorar Colecciones',
    'home.hero.featuredBtn': 'Ver Productos Destacados',

    'home.banner.title': 'Obtén 25% de DESCUENTO en Todos los Productos Digitales',
    ...
    'home.categories.description': 'Descubre nuestras colecciones curadas de productos digitales premium diseñados para cada aspecto de tu vida.',
    'home.categories.browse': 'Navegar',

    'home.featured.title': 'Productos Destacados',
    'home.featured.description': 'Productos digitales seleccionados que más aman nuestros clientes.',
    ...
    'products.description': 'Descubre nuestra colección completa de productos digitales premium',
    ...
    'checkout.instantDeliveryDesc': 'Los enlaces de descarga estarán disponibles inmediatamente después del pago',
    'checkout.secureCheckout': 'Pago Seguro',
    'checkout.stripeDescription': 'Completa tu compra con el sistema de pago seguro de Stripe',
    'checkout.email': 'Dirección de Email',
    'checkout.fullName': 'Nombre Completo',
    'checkout.acceptTerms': 'Acepto los Términos de Servicio y Política de Privacidad',
  ...
  fr: {
    ...
    'home.hero.description': 'Découvrez des eBooks, planificateurs, calendriers et outils numériques magnifiquement conçus pour élever votre flux de travail et inspirer votre meilleur travail.',
    ...
    'home.categories.description': 'Découvrez nos collections organisées de produits numériques premium conçus pour chaque aspect de votre vie.',
    'home.categories.browse': 'Parcourir',

    'home.featured.title': 'Produits Vedettes',
    'home.featured.description': 'Produits numériques sélectionnés que nos clients adorent le plus.',
    'home.featured.viewAll': 'Voir Tous les Produits',

    'home.banner.title': 'Obtenez 25% de RÉDUCTION sur Tous les Produits Numériques',
  ...
  de: {
    ...
    'home.hero.description': 'Entdecken Sie wunderschön gestaltete eBooks, Planer, Terminplaner und digitale Tools, die Ihren Workflow verbessern und Ihre beste Arbeit inspirieren.',
  ...
  pt: {
    ...
    'home.hero.description': 'Descubra eBooks, planejadores, agendas e ferramentas digitais lindamente criadas para elevar seu fluxo de trabalho e inspirar seu melhor trabalho.',
  ...
  ja: {
    ...
    'home.hero.description': 'ワークフローを向上させ、最高の仕事を刺激するために美しくデザインされたeBook、プランナー、スケジューラー、デジタルツールを発見してください。',
  ...
  zh: {
    ...
    'home.hero.description': '发现精美设计的电子书、规划器、调度器和数字工具，旨在提升您的工作流程并激发您的最佳作品。',
