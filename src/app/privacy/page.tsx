...
export const metadata = {
  ...
  description:
    "Privacy Policy and data protection practices for DigiNest.io digital marketplace",
};
          ...
          <CardContent className="prose prose-neutral max-w-none space-y-8">
            <section>
              ...
              <div className="space-y-4">
                ...
                <ul className="list-disc pl-6 space-y-2">
                  ...
                  <li>
                    Payment information processed by our secure payment
                    providers
                  </li>
            ...
            <section>
              ...
              <div className="space-y-4">
                ...
                <ul className="list-disc pl-6 space-y-2">
                  <li>
                    <strong>Payment Processors:</strong> Stripe and PayPal for
                    secure payment processing
                  </li>
                  <li>
                    <strong>Email Services:</strong> SendGrid or similar for
                  ...
                  <li>
                    <strong>Cloud Hosting:</strong> Netlify and Vercel for
                    website hosting
                  </li>
                </ul>
                ...
                <p>
                  ...
                  will notify users of any such change in ownership.
                </p>
              </div>
            </section>
            ...
            <section>
              ...
              <div className="space-y-4">
                ...
                <p>
                  ...
                  unsubscribe link or contacting support.
                </p>
            ...
            <section>
              ...
              <p>
                Account information is typically retained for 3 years after
                account closure, unless you request earlier deletion or we're
            ...
            <section>
              ...
              <div className="bg-neutral-100 p-4 rounded-lg mt-4">
                <p>
                  <strong>Email:</strong> privacy@diginest.io
                </p>
                <p>
                  <strong>Support:</strong> support@diginest.io
                </p>
                <p>
                  <strong>Data Protection Officer:</strong> dpo@diginest.io
                </p>
                <p>
                  <strong>Address:</strong> DigiNest.io, Privacy Department
                </p>
              </div>
            </section>
