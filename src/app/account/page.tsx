...
import { Download, ArrowLeft, Edit, Calendar, CreditCard, User, Package, Star, CheckCircle } from "lucide-react";
    ...
    items: [
      {
        ...
        price: 29.99,
        image: "https://ugc.same-assets.com/6jd4GpTcWCFWWhsxvoEQ6FImxgcD9bcY.jpeg",
    ...
    items: [
      {
        ...
        price: 19.99,
        image: "https://ugc.same-assets.com/80xGSN9gA5ZZ-dQBQi4Iy2W53I-QTr6V.jpeg",
      ...
      },
      {
        ...
        price: 24.99,
        image: "https://ugc.same-assets.com/POO9DdqexdiqS1yMBbpcyyty8PFkD3rG.jpeg",
...
export default function AccountPage() {
    ...
    return (
      <div className="min-h-screen bg-neutral-50 flex items-center justify-center">
        <div className="text-center">
          ...
          <p className="text-neutral-600 mb-6">You need to be logged in to access your account.</p>
          <Link href="/">
  ...
  const totalProducts = mockPurchases.reduce((sum, order) => sum + order.items.length, 0);
  ...
  return (
    <div className="min-h-screen bg-neutral-50">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        {/* Page Header */}
        <div className="mb-8">
          <h1 className="text-3xl font-light text-neutral-900 mb-2">My Account</h1>
          <p className="text-neutral-600">Manage your profile, downloads, and purchase history</p>
        </div>
        ...
        <Tabs defaultValue="purchases" className="w-full">
          ...
          <TabsContent value="purchases" className="mt-8">
            <div className="space-y-6">
              <h2 className="text-xl font-medium text-neutral-900">Purchase History</h2>
          ...
          <TabsContent value="downloads" className="mt-8">
            <div className="space-y-6">
              <h2 className="text-xl font-medium text-neutral-900">My Downloads</h2>

              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                {mockPurchases.flatMap(order => order.items).map((item) => (
              ...
              <Card>
                ...
                <CardContent className="space-y-4">
                  {isEditing ? (
                    <>
                      ...
                      <div className="flex gap-2">
                        <Button onClick={handleProfileUpdate} className="bg-neutral-900 hover:bg-neutral-800">
                          Save Changes
                        </Button>
                  ...
                  <div className="pt-6 border-t">
                    <h4 className="font-medium text-neutral-900 mb-4">Account Actions</h4>
