...
const mockProducts: Product[] = [
  {
    ...
    description: "Complete planning system for iPad and tablets with monthly, weekly, and daily layouts",
    price: 29.99,
  ...
  },
  {
    ...
    description: "Complete guide to maximizing your efficiency with proven strategies and techniques",
    price: 19.99,
  ...
  },
  {
    ...
    description: "Mindful planning for wellness and balance with habit trackers and reflection pages",
    price: 24.99,
  ...
  },
  {
    ...
    description: "Professional task management templates for teams and individuals",
    price: 14.99,
  ...
  },
  {
    ...
    description: "Showcase your creative work with this professional portfolio template",
    price: 39.99,
  ...
  },
  {
    ...
    description: "Comprehensive financial planning and budgeting workbook with calculators",
    price: 27.99,
  ...
  // NEW HEALTH & FITNESS PRODUCTS
  {
    ...
    description: "Advanced Excel/Google Sheets template for precise calorie and macro tracking with meal planning",
    price: 22.99,
  ...
  },
  {
    ...
    description: "Progressive strength training plan with exercise library and progress tracking",
    price: 34.99,
  ...
  },
  {
    ...
    description: "Interactive workout journal for tracking sets, reps, weights, and personal records",
    price: 18.99,
  ...
  },
  {
    ...
    description: "Calculate your macros and plan balanced meals with automated shopping lists",
    price: 25.99,
  ...
  },
  {
    ...
    description: "30-day home workout program with video guides for all fitness levels",
    price: 45.99,
  ...
  },
  {
    ...
    description: "Digital planner for tracking fasting windows, meals, and health metrics",
    price: 15.99,
  ...
  },
  {
    ...
    description: "Beautiful illustrated yoga sequences for morning, evening, and stress relief",
    price: 21.99,
  ...
  },
  {
    ...
    description: "Comprehensive guide to improving sleep quality and recovery with tracking templates",
    price: 19.99,
  ...
  },
  {
    ...
    description: "Complete bodyweight exercise program with progression charts and form guides",
    price: 28.99,
  ...
  },
  {
    ...
    description: "Track daily water intake, supplements, and health metrics with reminder system",
    price: 12.99,
  ...
  // Additional eBooks
  {
    ...
    description: "Complete guide to modern digital marketing strategies including SEO, social media, and PPC",
    price: 34.99,
    image: "https://ugc.same-assets.com/s5O7a8ldSmwD4vVf-5T89qmCmnnpQCO4.jpeg",
    category: "ebooks",
    rating: 4.8,
  ...
  },
  {
    ...
    description: "Practical guide to mindfulness and meditation practices for stress reduction and mental clarity",
    price: 22.99,
    image: "https://ugc.same-assets.com/DJAgD61a-4T_nzFwTL1ekGXObpjr-hMN.jpeg",
    category: "ebooks",
    rating: 4.9,
  ...
  },
  {
    ...
    description: "Everything you need to know to start and grow a successful freelancing business",
    price: 27.99,
    image: "https://ugc.same-assets.com/s5O7a8ldSmwD4vVf-5T89qmCmnnpQCO4.jpeg",
    category: "ebooks",
    rating: 4.6,
  ...
  },
  {
    ...
    description: "Master the basics of photography with this comprehensive beginner's guide",
    price: 24.99,
    image: "https://ugc.same-assets.com/AkLo0ZKe4I00cqqWt5-74qVVQT79X85U.jpeg",
    category: "ebooks",
    rating: 4.7,
  ...
  },
  {
    ...
    description: "Essential strategies for productivity and success in remote work environments",
    price: 19.99,
    image: "https://ugc.same-assets.com/s5O7a8ldSmwD4vVf-5T89qmCmnnpQCO4.jpeg",
    category: "ebooks",
    rating: 4.5,
  ...
  // Additional Planners
  {
    ...
    description: "Student planner with semester tracking, assignment management, and study schedules",
    price: 26.99,
    image: "https://ugc.same-assets.com/bTHIWwJOBZ8ti0Zl7ZVoJy98XTtb4Xa5.jpeg",
    category: "planners",
    rating: 4.8,
  ...
  },
  {
    ...
    description: "Complete wedding planning system with checklists, budgets, and vendor management",
    price: 35.99,
    image: "https://ugc.same-assets.com/DJAgD61a-4T_nzFwTL1ekGXObpjr-hMN.jpeg",
    category: "planners",
    rating: 4.9,
  ...
  },
  {
    ...
    description: "Social media content planning and scheduling system for creators and brands",
    price: 31.99,
    image: "https://ugc.same-assets.com/bTHIWwJOBZ8ti0Zl7ZVoJy98XTtb4Xa5.jpeg",
    category: "planners",
    rating: 4.7,
  ...
  },
  {
    ...
    description: "Plan your perfect trip with itinerary templates, packing lists, and travel logs",
    price: 23.99,
    image: "https://ugc.same-assets.com/DJAgD61a-4T_nzFwTL1ekGXObpjr-hMN.jpeg",
    category: "planners",
    rating: 4.6,
  ...
  // Additional Templates
  {
    ...
    description: "Professional invoice templates for freelancers and small businesses",
    price: 16.99,
    image: "https://ugc.same-assets.com/nf9vBokQDSYdZTtPrSBVR2X8O_YrhOXq.jpeg",
    category: "templates",
    rating: 4.5,
  ...
  },
  {
    ...
    description: "Instagram, Facebook, and LinkedIn post templates for consistent branding",
    price: 28.99,
    image: "https://ugc.same-assets.com/AkLo0ZKe4I00cqqWt5-74qVVQT79X85U.jpeg",
    category: "templates",
    rating: 4.8,
  ...
  },
  {
    ...
    description: "Professional email newsletter templates for marketing campaigns",
    price: 24.99,
    image: "https://ugc.same-assets.com/nf9vBokQDSYdZTtPrSBVR2X8O_YrhOXq.jpeg",
    category: "templates",
    rating: 4.6,
  ...
  },
  {
    ...
    description: "Modern PowerPoint and Keynote templates for business presentations",
    price: 32.99,
    image: "https://ugc.same-assets.com/AkLo0ZKe4I00cqqWt5-74qVVQT79X85U.jpeg",
    category: "templates",
    rating: 4.7,
  ...
  // Additional Design Tools
  {
    ...
    description: "Complete logo design toolkit with icons, fonts, and brand guidelines",
    price: 45.99,
    image: "https://ugc.same-assets.com/AkLo0ZKe4I00cqqWt5-74qVVQT79X85U.jpeg",
    category: "tools",
    rating: 4.8,
  ...
  },
  {
    ...
    description: "Professional color palettes and hex codes for web and print design",
    price: 18.99,
    image: "https://ugc.same-assets.com/nf9vBokQDSYdZTtPrSBVR2X8O_YrhOXq.jpeg",
    category: "tools",
    rating: 4.5,
  ...
  },
  {
    ...
    description: "Curated collection of professional fonts for branding and design projects",
    price: 38.99,
    image: "https://ugc.same-assets.com/AkLo0ZKe4I00cqqWt5-74qVVQT79X85U.jpeg",
    category: "tools",
    rating: 4.9,
  ...
  },
  {
    ...
    description: "Thousands of professional icons in multiple formats for all your design needs",
    price: 42.99,
    image: "https://ugc.same-assets.com/nf9vBokQDSYdZTtPrSBVR2X8O_YrhOXq.jpeg",
    category: "tools",
    rating: 4.7,
  ...
  },
  {
    ...
    description: "Complete guide to improving sleep quality with tracking templates",
    price: 19.99,
    image: "https://ugc.same-assets.com/il21uiaNPQItlsYi3EMwn-IfAbiCorr2.jpeg",
    category: "health",
    rating: 4.8,
  ...
  // Additional Fitness Products
  {
    ...
    description: "Detailed yoga sequences for all levels with pose illustrations and breathing guides",
    price: 26.99,
    image: "https://ugc.same-assets.com/2H0CqkPAsVBawi7qVT4bTHAZ8Ij43CQI.jpeg",
    category: "fitness",
    rating: 4.9,
  ...
  },
  {
    ...
    description: "16-week marathon training program with weekly schedules and nutrition plans",
    price: 29.99,
    image: "https://ugc.same-assets.com/8QM59VVMWstqjmqYUFFIGf07POvDew1_.png",
    category: "fitness",
    rating: 4.8,
  ...
  },
  {
    ...
    description: "Daily stretching and mobility routines for improved flexibility and injury prevention",
    price: 18.99,
    image: "https://ugc.same-assets.com/8QM59VVMWstqjmqYUFFIGf07POvDew1_.png",
    category: "fitness",
    rating: 4.7,
            ...
            <Card key={product.id} className="group hover:shadow-lg transition-all duration-300 border-neutral-200">
                ...
                <div className="aspect-square bg-gradient-to-br from-neutral-100 to-neutral-200 relative overflow-hidden">
                  ...
                  {product.rating >= 4.8 && (
                    <div className="absolute top-4 right-4">
                      <Badge className="bg-neutral-900 text-white">Bestseller</Badge>
                    </div>
                  )}
                </div>
              </Link>
              ...
              <CardContent>
                <div className="flex justify-between items-center">
                  <div className="text-2xl font-light text-neutral-900">${product.price.toFixed(2)}</div>
                  <Button
                    size="sm"
