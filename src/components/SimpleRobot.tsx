...
export function SimpleRobot({ emotion = "happy" }: SimpleRobotProps) {
  ...
  const eyeX =
    typeof window !== "undefined"
      ? (mousePosition.x / window.innerWidth - 0.5) * 6
      : 0;
  const eyeY =
    typeof window !== "undefined"
      ? (mousePosition.y / window.innerHeight - 0.5) * 6
      : 0;
  ...
  const getMouthShape = () => {
    switch (emotion) {
      case "happy":
        return "M 25 35 Q 40 45 55 35";
      case "excited":
        return "M 25 35 Q 40 50 55 35";
      case "celebrating":
        return "M 25 35 Q 40 50 55 35";
      case "thinking":
        return "M 30 40 L 50 40";
      case "curious":
        return "M 35 35 Q 40 45 45 35";
      default:
        return "M 30 40 L 50 40";
    }
  };
      ...
      <div className="relative">
        ...
        <motion.div
          ...
          transition={{
            ...
            scale: {
              repeat: emotion === "excited" ? Number.POSITIVE_INFINITY : 0,
              duration: 0.8,
            },
          }}
        >
          ...
          >
            ...
            <motion.rect
              ...
              transition={{
                repeat:
                  emotion === "celebrating" ? Number.POSITIVE_INFINITY : 0,
                duration: 0.6,
              }}
