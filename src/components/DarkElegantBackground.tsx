...
export function DarkElegantBackground({
  intensity = "medium",
}: DarkElegantBackgroundProps) {
  ...
  const particleCount =
    intensity === "low" ? 20 : intensity === "medium" ? 40 : 60;
  ...
  return (
    <div
      ...
      style={{
        zIndex: 1,
        background:
          "linear-gradient(135deg, #1a1a1a 0%, #2d2d2d 25%, #1a1a1a 50%, #404040 75%, #1a1a1a 100%)",
    ...
    >
      ...
      <motion.div
        ...
        style={{
          background:
            "linear-gradient(45deg, #000000 0%, #1a1a1a 25%, #2d2d2d 50%, #404040 75%, #1a1a1a 100%)",
          backgroundSize: "400% 400%",
        }}
        animate={{
        ...
        return (
          <motion.div
            ...
            style={{
              ...
              height: size,
              background:
                "radial-gradient(circle, rgba(0, 0, 0, 0.4) 0%, rgba(45, 45, 45, 0.2) 50%, transparent 70%)",
              filter: "blur(30px)",
            }}
            initial={{
              x: `${startX}%`,
          ...
          >
            ...
            {i % 3 === 1 && (
              <div
                ...
                style={{
                  background:
                    "linear-gradient(45deg, rgba(0,0,0,0.3), rgba(45,45,45,0.2))",
            ...
            {i % 3 === 2 && (
              <div
                ...
                style={{
                  background:
                    "linear-gradient(135deg, rgba(64,64,64,0.2) 0%, transparent 70%)",
        ...
        return (
          <motion.div
            ...
            style={{
              ...
              height: size,
              background:
                "radial-gradient(circle, rgba(128, 128, 128, 0.6), rgba(64, 64, 64, 0.3))",
      ...
      <motion.div
        ...
        style={{
          background:
            "radial-gradient(circle, rgba(45, 45, 45, 0.5) 0%, transparent 70%)",
          filter: "blur(50px)",
        }}
        animate={{
          scale: [1.3, 1, 1.3],
      ...
      <motion.div
        ...
        style={{
          background:
            "linear-gradient(90deg, transparent, rgba(0, 0, 0, 0.3), rgba(64, 64, 64, 0.2), transparent)",
          filter: "blur(60px)",
          borderRadius: "50%",
        }}
        animate={{
